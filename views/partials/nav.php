...
function manageActive($uri) {
    ...
    $DEFAULT_LINK = "rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white";

    return $current_uri === $uri ? $ACTIVE_CLASS_ATTRS . " " . $DEFAULT_LINK : $DEFAULT_LINK;
}
